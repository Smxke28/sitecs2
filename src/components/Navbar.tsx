    ...
    <>
        ...
        <div style={{
          ...
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '10px', textDecoration: 'none', flexShrink: 0 }}>
            <div style={{
              ...
              boxShadow: '0 0 14px rgba(232,25,44,0.4)',
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: '1.05rem', color: '#F5F5F8', lineHeight: 1, letterSpacing: '0.02em' }}>
                CS2 Utility Hub
              </span>
              <span className="hidden md:block" style={{ fontSize: '0.62rem', color: '#444455', fontFamily: "'JetBrains Mono', monospace", letterSpacing: '0.08em' }}>
                TÁTICAS & MAPAS
              </span>
            </div>
          </Link>
                ...
                return (
                  ...
                  >
                    <button style={{
                      ...
                      color: active ? '#E8192C' : '#888899',
                      padding: '6px 12px', borderRadius: '8px',
                      background: active ? 'rgba(232,25,44,0.08)' : 'transparent',
                      border: active ? '1px solid rgba(232,25,44,0.15)' : '1px solid transparent',
                    ...
                    {mapsOpen && (
                      <div style={{
                        ...
                        width: '160px', background: 'rgba(14,14,18,0.98)',
                        border: '1px solid rgba(232,25,44,0.2)', borderRadius: '12px',
                        ...
                        {mapas.map(m => (
                          <Link key={m.href} href={m.href} style={{
                            ...
                            fontSize: '0.85rem', color: pathname === m.href ? '#E8192C' : '#AAAACC',
                            background: pathname === m.href ? 'rgba(232,25,44,0.08)' : 'transparent',
                            textDecoration: 'none', transition: 'all 0.15s',
                            fontWeight: pathname === m.href ? 600 : 400,
                          }}>
                            {m.nome}
      ...
      <nav
        ...
        style={{
          ...
          borderRight: '1px solid rgba(232,25,44,0.12)',
          zIndex: 60,
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <div style={{
              ...
              background: 'linear-gradient(135deg, #E8192C, #8B0000)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: '0.75rem', color: '#fff',
              boxShadow: '0 0 10px rgba(232,25,44,0.35)',
            }}>CS2</div>
            <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: '0.95rem', color: '#F5F5F8', letterSpacing: '0.02em' }}>
              CS2 Utility Hub
            </span>
          </div>
          <button onClick={() => setSidebarOpen(false)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#444455', padding: '4px' }}>
            <X size={20} />
          </button>
        </div>
        ...
        <div style={{ flex: 1, padding: '20px 12px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: '2px' }}>
          <p style={{ fontSize: '0.62rem', fontFamily: "'JetBrains Mono', monospace", textTransform: 'uppercase', letterSpacing: '0.12em', color: '#444455', padding: '0 8px', marginBottom: '10px' }}>
            Navegação
          </p>
          ...
          {[{ label: 'Início', href: '/' }, { label: 'Sobre', href: '/Sobre' }, { label: 'Contato', href: '/Contato' }].map(link => {
            ...
            return (
              <Link key={link.href} href={link.href} style={{
                ...
                fontSize: '0.93rem', fontWeight: active ? 600 : 400,
                color: active ? '#E8192C' : '#AAAACC',
                background: active ? 'rgba(232,25,44,0.08)' : 'transparent',
                border: '1px solid', borderColor: active ? 'rgba(232,25,44,0.15)' : 'transparent',
        ...
        <div style={{ padding: '16px', borderTop: '1px solid rgba(255,255,255,0.05)', flexShrink: 0 }}>
          <Link href="/Mapas/Mirage" className="btn-red" style={{ width: '100%', justifyContent: 'center', fontSize: '0.85rem' }}>
            Começar agora →
          </Link>
        </div>
      </nav>
