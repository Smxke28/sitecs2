    ...
    <div className="min-h-screen bg-black text-white px-6 py-10">
      ...
      <header className="max-w-6xl mx-auto mb-14 text-center">
        <h1 className="text-5xl font-extrabold bg-gradient-to-r from-red-600 to-red-400 bg-clip-text text-transparent drop-shadow-lg">
          Mirage — Guia Completo
        </h1>

        <p className="text-gray-400 mt-3 text-lg">
          Todas as utilidades, pulos, execuções e posições essenciais para dominar o mapa.
        </p>
      ...
      {/* MODAIS */}
      {activeModal === "smokes" && (
        <Modal title="Smokes — Mirage" close={closeModal}>
          <VideoBlock
      ...
      {activeModal === "flashes" && (
        <Modal title="Flashbangs — Mirage" close={closeModal}>
          <VideoBlock
            video="/videos/flash-mid.mp4"
            desc="Flash para pegar mid avançado."
          />
          <VideoBlock video="/videos/flash-a.mp4" desc="Flash estourada A." />
        </Modal>
      )}

      {activeModal === "molotovs" && (
        <Modal title="Molotovs — Mirage" close={closeModal}>
          <VideoBlock
      ...
      {activeModal === "jumps" && (
        <Modal title="Pulos — Mirage" close={closeModal}>
          <VideoBlock
